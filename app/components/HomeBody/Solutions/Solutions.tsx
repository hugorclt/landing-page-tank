...
const cards = [
  {
    ...
    paragraph:
      "JOIN provides recruiters with the tools to elevate their work to the next level.",
  },
  {
  ...
  },
  {
    ...
    paragraph:
      "Post to multiple job boards at once, including Glassdoor, Indeed, and many more.",
  },
  {
    ...
    paragraph:
      "Profiter d'une embauche en un clic, afin de gagner du temps au moment de l'embauche.",
  },
  {
    ...
    paragraph:
      "Profiter d'un réseau à l'échelle européenne, de candidats diplômé",
  },
  {
  ...
  return (
    <section className={styles.solutionsContainer}>
      ...
      <div className={styles.solutionsCardsContainer}>
        {cards.map((card, idx) => {
          return <SolutionCard key={idx} {...card} />;
        })}
      </div>
    </section>
  );
